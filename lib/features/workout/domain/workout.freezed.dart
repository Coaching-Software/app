...
class _$WorkoutImpl implements _Workout {
  ...
  @override
  String toString() {
    return 'Workout(id: $id, name: $name, description: $description, athletes: $athletes, date: $date)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description,
      const DeepCollectionEquality().hash(_athletes), date);
...
abstract class _Workout implements Workout {
  const factory _Workout(
      ...
      required final List<String> athletes,
      required final String date}) = _$WorkoutImpl;
